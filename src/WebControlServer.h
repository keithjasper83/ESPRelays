...
using ResetReasonGetter = const char *(*)();
using BrownoutCountGetter = uint32_t (*)();
using TemperatureStorageSlotGetter = const char *(*)();
using TemperatureStorageGenerationGetter = uint8_t (*)();
...
struct WebControlContext
{
    ...
    ResetReasonGetter getResetReason = nullptr;
    BrownoutCountGetter getBrownoutCount = nullptr;
    TemperatureProbePresentGetter getTemperatureStorageLoadOk = nullptr;
    TemperatureProbePresentGetter getTemperatureStorageWriteVerified = nullptr;
    TemperatureStorageSlotGetter getTemperatureStorageSlot = nullptr;
    TemperatureStorageGenerationGetter getTemperatureStorageGeneration = nullptr;
